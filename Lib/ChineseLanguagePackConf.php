...
namespace Modules\ModuleChineseLanguagePack\Lib;

use MikoPBX\Modules\Config\ConfigClass;
use Modules\ModuleChineseLanguagePack\Lib\RestAPI\Controllers\SoundsController;

/**
 * ChineseLanguagePackConf
 *
 * Wires the per-module REST endpoints (sounds inventory + conversion progress).
 */
class ChineseLanguagePackConf extends ConfigClass
{
    public const string ROUTE_PREFIX = '/pbxcore/api/v3/module-chinese-language-pack';
