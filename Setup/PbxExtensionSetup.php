...
namespace Modules\ModuleChineseLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Chinese Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Chinese UI translations from Messages/zh_Hans/ directory
 * - Chinese voice prompts from Sounds/zh-cn/ directory
 *
 ...
 *
 * @package Modules\ModuleChineseLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleChineseLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Chinese packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Chinese Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Chinese Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Chinese Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Chinese Language Pack uninstalled successfully',
            LOG_INFO
        );
